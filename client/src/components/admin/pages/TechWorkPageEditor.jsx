...
const TechWorkPageEditor = () => {
  ...
  const SECTION_KEY = 'tws_hero';
  const PAGE_NAME = 'techworksstudio';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('TechWork Studio content updated successfully!');
    } catch (error) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="border-b border-gray-200 pb-6">
        <h3 className="text-lg font-semibold text-gray-800 mb-4">TechWork Studio Hero Section</h3>
...
export default TechWorkPageEditor;
