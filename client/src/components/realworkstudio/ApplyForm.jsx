...
export default function ContactForm({ successMessage }) {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      // 👇 FIX: Use publicApi.submitLead
      await publicApi.submitLead({
        name: nameWithCompany,
        email: form.email,
        phone: form.phone,
        interestType: "CLIENT", // Ya "PARTNER" agar ye partnership form hai
        
        // 👇 CRITICAL FIX: RealWork ke liye 'RWS' hona chahiye, 'TWS' nahi
        division: "RWS", 
